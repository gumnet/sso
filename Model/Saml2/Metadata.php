...
class Metadata
{
    ...
    public const TIME_CACHED = 604800; // 1 week
...
METADATA_TEMPLATE;
     ...
     * @throws Exception
     */
    public function signMetadata($metadata, $key, $cert, $signAlgorithm = XMLSecurityKey::RSA_SHA1, $digestAlgorithm = XMLSecurityDSig::SHA1)
    {
     ...
     * @throws Exception
     */
    public function addX509KeyDescriptors($metadata, $cert, $wantsEncrypted = true)
    {
        $xml = new DOMDocument();
