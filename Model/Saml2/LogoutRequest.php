    ...
    public function __construct(Settings $settings, $request = null, $nameId = null, $sessionIndex = null, $nameIdFormat = null, $nameIdNameQualifier = null, $nameIdSPNameQualifier = null)
    {
        ...
        if (!isset($request) || empty($request)) {
            ...
            */
            ...
            $destination = $this->settings->getIdPSLOUrl();
        ...
        try {
            ...
            if ($this->settings->isStrict()) {
                ...
                if ($security['wantXMLValidation']) {
                    $res = Utils::validateXML($dom, 'saml-schema-protocol-2.0.xsd', $this->settings->isDebugActive(), $this->settings->getSchemasPath());
                ...
                $nameId = static::getNameId($dom, $this->settings->getSPkey());
